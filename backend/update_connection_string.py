#!/usr/bin/env python3
"""
Update the connection string in the database
"""
import asyncio
import sys
...
async def update_connection_string():
    """Update the connection string in the database"""
    ...
    try:
        async with async_session() as session:
            print("🔧 Updating connection string in database...")
            ...
            if ws_row:
                ...
                print(f"   New connection string: {connection_string}")
                ...
                update_query = text("""
                    ...
                    SET mssql_connection_string = :encrypted_string
...
if __name__ == "__main__":
    asyncio.run(update_connection_string())