    ...
    async with AsyncSessionLocal() as db:
        ...
        if configs:
            for config in configs:
                ...
                print(f"Custom Queries: {config.custom_queries_text}")
                print("-" * 60)
        else:
            ...
            print("\nThis is why equipment data is being fetched from the database.")
            print("If you have configured a data source with custom queries,")
            print("please check that it was saved correctly.")
